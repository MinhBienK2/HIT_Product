...
import friendRequest from '../../../assets/icons/friendRequest.svg'
    ...
    <div className="friendsRequestLeft">
        ...
        <div className="friendsRequestLeft_choose">
            ...
            <div className="friendsRequestLeft_choose-items-main">
                <div className="friendsRequestLeft_choose-items-main-left" onClick={() => navigate('/')}>
                    <img src={home} alt="" />
                    <p>Trang chủ</p>
                </div>
            ...
            <div className="friendsRequestLeft_choose-items">
                <div className="friendsRequestLeft_choose-items-left" onClick={() => navigate('/FriendsRequest')}>
