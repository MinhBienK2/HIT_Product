                    ...
                    <div className="signup__taskbar">
                        <div className="signup__taskbar-left">
                            ...
                            <div className="signup__taskbar-left-text">
                                ...
                                <p className="signup__taskbar-left-text-text2">
                                    RICK
                                </p>
                            </div>
                        </div>
                        <div className="signup__taskbar-right">
                            <button
                                className="signup__taskbar-right-btn1"
                                onClick={handleLogin}
                            >
                                Đăng nhập
                            </button>
                            <button className="signup__taskbar-right-btn2">
                                Đăng kí
                            </button>
                        </div>
                    </div>
                    <div className="signup__main">
                        ...
                        <div className="signup__main-right">
                            <div className="signup__main-right-outer">
                                <p className="signup__main-right-outer-signup">
                                    ĐĂNG KÍ
                                </p>
