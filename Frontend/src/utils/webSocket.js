...
import {setupIsVideoCall,setupLinkToPageVideoCall,setupFriendPeerId} from '../store/reducers/callVideo'
...
export const sendPeerIdToFriend = (data) =>  socket.emit("sendPeerIdToFriend",data)
